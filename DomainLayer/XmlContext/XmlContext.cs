...
namespace DomainLayer.XmlContext
{
    public class XmlContext
    {
        ...
        public void Save()
        {
            ...
            XmlSerializationHelper<List<Tag>>.Serialize(XmlConstants.DefaultCommentsXml, Tags);
            XmlSerializationHelper<List<RecipeTag>>.Serialize(XmlConstants.DefaultCommentsXml, RecipeTags);
        }
    }
}
